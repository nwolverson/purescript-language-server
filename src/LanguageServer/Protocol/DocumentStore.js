...
exports.getDocuments = function (documents) { return function () {
    return documents.all();
}; };
exports.getDocument = function (documents) { return function (uri) { return function () {
    return documents.get(uri);
}; }; };
exports.onDidSaveDocument = function (documents) {
    return function (f) {
        return function () {
...
exports.onDidOpenDocument = function (documents) {
    return function (f) {
        return function () {
...
exports.onDidCloseDocument = function (documents) {
    return function (f) {
        return function () {
...
exports.onDidChangeContent = function (documents) {
    return function (f) {
        return function () {
